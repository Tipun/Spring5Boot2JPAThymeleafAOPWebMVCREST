...
import com.jrp.pma.dao.EmployeeRepositoryPage;
...
public class EmployeeApiController {
	...
	@Autowired
	EmployeeRepositoryPage empRepoP;
	...
	// обновляет с удалением из других таблиц 
	...
	// обновляет без удаления из других таблиц 
	...
	public Iterable<Employee> findPaginatedEmployees(@RequestParam("page") int page, 
		...
		return empRepoP.findAll(pageAndSize);
	}
}
